...
Namespace RichEditSendMail
	Partial Public Class Form1
		...
		Public Class RichEditMailMessageExporter
			...
			Private Function GetActualImageFormat(ByVal richEditImageFormat As RichEditImageFormat) As RichEditImageFormat
				If (richEditImageFormat = RichEditImageFormat.Exif) OrElse (richEditImageFormat = RichEditImageFormat.MemoryBmp) Then
